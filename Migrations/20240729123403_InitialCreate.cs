        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentCourses_Accounts_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courses_Modules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Courses_Modules_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Courses_Modules_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_Modules_CourseId",
                table: "Courses_Modules",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Courses_Modules_ModuleId",
                table: "Courses_Modules",
                column: "ModuleId");
